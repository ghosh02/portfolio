...
import "./Btn.css"; // Import the CSS file
  ...
  return (
    <div className="container">
      <button
        ...
        onClick={handleClick}
      >
        <span className={`default ${isActive ? "hidden" : ""}`}>Send</span>
        <span className={`success ${isActive ? "visible" : ""}`}>Sent</span>
        <div className="left"></div>
        <div className="right"></div>
      </button>

      {/* Dribbble and Twitter Links */}
      <a
        className="dribbble"
